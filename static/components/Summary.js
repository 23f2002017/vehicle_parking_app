    ...
    template : `
        <div>
            <div v-if="role === 'admin'">
                ...
                <div v-if="(details.total_parking_lots > 0) && (details.total_users > 0)">
                    <h1>Summary</h1>
                ...
                <p v-else style='color: red;'>No activity on the app yet.</p>    
            </div> 
            <div v-else>
                <user-nav-bar></user-nav-bar>
                <div v-if="status">
                    <h2>Summary</h2>
                    <div v-if="details.total_parkings > 0">
                        <img src="./static/images/summary.png" alt="Summary Plot" style="width: 100%; max-width: 600px; height: auto;"><br>
                        <div style="margin: 20px 50px; font-size: 120%; line-height: 1.5;">
                            Total Parkings: {{ details.total_parkings }}<br>
                            No. of Current Parkings: {{ details.total_current_parkings }}<br>
                    ...
                    <p v-else style="color: red; margin-left: 20px;">No activity on the app yet.</p>
                </div>
